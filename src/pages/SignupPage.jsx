...
export default function SignupPage() {
  ...
  return (
    <section className="bg-white min-h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
